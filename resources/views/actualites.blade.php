...
@section('title', 'Actualites | Arttech')
@include('navbar')
@section('content')
<main>
   <section class="actualites">
      <div class="section-header-content">
         <h1>Actualités</h1>
         <p>"Envie de rester à jour sur les dernières tendances technologiques ? Découvrez nos articles passionnants et soyez au courant des dernières avancées."</p>
      </div>
      <div class="container-actualites">
         <div class="actualite-card">
            ...
            <div class="card-content">
               ...
               <span class="content">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod...</span>
