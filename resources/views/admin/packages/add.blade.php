            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200 flex flex-col justify-center items-center">
                    <form class="flex justify-start items-center w-full flex-col"
                        action="{{ route('admin.packages.add.submit') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mt-4 w-full">
                            ...
                            <textarea name="includes" rows="10" class="block mt-1 w-full rounded" required></textarea>
                        </div>
