                ...
                <div class="p-6 bg-white border-b border-gray-200 flex flex-col justify-center items-center">
                    <form class="flex justify-start items-center w-full flex-col" action="{{ route('admin.packages.edit.submit', $package->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="w-full">
                            ...
                            <x-input id="name" class="block mt-1 w-full" type="text" name="name" value="{{ $package->name }}" required />
                        </div>
                        ...
                        <div class="flex flex-row justify-evenly w-full">
                            <a class="text-white bg-gray-800 rounded px-5 h-10 text-center cursor-pointer my-2 flex items-center" href="{{ route('admin.packages') }}">Cancel</a>
